...
results_vs_no_min_conc = merge_files(relative_auc_decrease, relative_auc_decrease_no_min_conc)
...
results_vs_no_max_conc = merge_files(relative_auc_decrease, relative_auc_decrease_no_max_conc)
...
results_vs_no_minmax_conc = merge_files(relative_auc_decrease, relative_auc_decrease_no_minmax_conc)
...
results_no_min_conc_vs_no_max_conc = merge_files(relative_auc_decrease_no_min_conc, relative_auc_decrease_no_max_conc)
